...
namespace rtype
{
    ...
    {
        switch (sprite) {
            case SPRITES::SIMPLE_MONSTER: return 20;
            case SPRITES::ADVANCED_MONSTER: return 30;
            case SPRITES::BABY_PROJECTILE: return 20;
            case SPRITES::MEGA_MONSTER: return 50;
            case SPRITES::SIMPLE_BOSS: return 500;
            default: return 0;
        }
    }
    ...
    int GameplayFactory::getProjectilesDamage(SPRITES sprite)
    {
        switch (sprite) {
            ...
            case PLAYER_RED_MISSILE: return (getPlayerPlayerDamage() * 3);
            case PLAYER_RED_CHARGED_SHOOT: return (getPlayerPlayerDamage() * 5);
            ...
            case FIRE_BALL: return getMonsterDamage(SPRITES::MEGA_MONSTER);
            case BOSS_PROJECTILE: return getMonsterDamage(SPRITES::SIMPLE_BOSS);
            case ASTEROIDE: return std::get<2>(asteroids);
            default: std::cerr << "Monster Id not found" << std::endl; return 0;
        }
    }
    ...
    {
        switch (sprite) {
            case SPRITES::SIMPLE_BOSS: return 100;
            default: return 1;
        }
    }
