...
namespace rtype
{
    void GameplayFactory::init(const std::string &filename)
    {
        ...
        const libconfig::Setting &monsterSettings =
            root["gameplay"]["monsters"];
        ...
        const libconfig::Setting &bonusSpeedSettings =
            root["gameplay"]["bonus"];
        int bonus_spe;
        bonusSpeedSettings.lookupValue("speed", bonus_spe);
        bonus_speed = bonus_spe;

        const libconfig::Setting &bonusVelocitySettings =
            root["gameplay"]["bonus"]["velocity"];
        int boost, duration;
        ...
        const libconfig::Setting &bonusLifeSettings =
            root["gameplay"]["bonus"]["life"];
        bonusLifeSettings.lookupValue("boost", boost);
        bonuses[BONUS::LIFE] = std::make_pair(boost, duration);

        const libconfig::Setting &bonusShieldSettings =
            root["gameplay"]["bonus"]["shield"];
        bonusShieldSettings.lookupValue("duration", duration);
        bonuses[BONUS::SHIELD] = std::make_pair(boost, duration);

        const libconfig::Setting &bonusWeaponSettings =
            root["gameplay"]["bonus"]["weapon"];
