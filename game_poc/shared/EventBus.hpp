 ...
 */
    ...
    namespace poc_game
    {
        ...
        public:
             ...
             */
            void subscribe(POC_GAME_ACTIONS type, std::function<void(const std::vector<std::any> &)> listener)
            {
            ...
            void emit(POC_GAME_ACTIONS type, Args &&...args)
            {
        ...
        private:
            std::unordered_map<POC_GAME_ACTIONS, std::vector<std::function<void(const std::vector<std::any> &)>>> subscribers;
        };
    }
