        ...
        try
        {
            ...
            if (isServer)
            {
                if (cfg.exists("server.tps"))
                {
                    ...
                    {
                        throw ERROR::InvalidTpsOrFpsExceptions("Server TPS doit être supérieur à 0");
                    }
                }
                else
                {
            ...
            else
            {
                if (cfg.exists("client.tps"))
                {
                    ...
                    {
                        throw ERROR::InvalidTpsOrFpsExceptions("Client tps doit être supérieur à 0");
                    }
                }
                else
                {
                ...
                if (cfg.exists("client.fps"))
                {
                    ...
                    {
                        throw ERROR::InvalidTpsOrFpsExceptions("Client fps doit être supérieur à 0");
                    }
                }
                else
                {
