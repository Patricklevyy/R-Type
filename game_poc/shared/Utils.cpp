...
namespace poc_game
{
    ...
    std::tuple<float, float, int> Utils::parsePositionAndRoomPort(const std::string &input)
    {
    ...
    std::list<std::tuple<std::size_t, float, float>> Utils::parse_update(const std::string &params) {
